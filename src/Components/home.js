        ...
        <div className="">
            ...
            <nav className="navbar navbar-expand-lg bg-info">
                <div className="container-fluid ps-4">
                    <a className="navbar-brand ms-3 col-4" href="#"><img src={img1} style={{ height: "50px", width: "50px", borderRadius: "50%" }} /><b className="fs-4 ">DELUX</b>MEDICALS
                    </a>
            ...
            {/* ----------------------------------------------------------------- */}
            {/* Home page part */}
            <section style={{ backgroundColor: "lightsalmon" }}>
                ...
                <section>
                    <div className='container pt-5 d-flex flex-wrap' style={{}}>
                        <div className='text-center col-lg-6 col-sm-12 ' style={{ padding: "70px 30px" }}>
                            <h4 style={{ fontStyle: "oblique" }}>"Your one-stop healthcare shop,<br />E-Pharmacy! "</h4>
                            <p className=" text-center " style={{ fontSize: "19px" }}>Our Pharmacy offers effective Medical products, healthcare solutions to all those individuals who are health enthusiasts. Providing over 20,000 health  and ayurvedic herbal medicines online at the lowest guaranteed price - with the highest pharmaceutical standards.</p>
                        </div>
                    ...
                    <div id="carouselExampleControls" className="carousel slide container-sm mt-5 mb-4"
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img src={img3} style={{ height: "500px", borderRadius: "10px" }} className="d-block w-100"
                                    alt="carousel Images" />
                            </div>
                            <div className="carousel-item active">
                                <img src={img4} style={{ height: "500px", borderRadius: "10px" }} className="d-block w-100"
                                    alt="carousel Images" />
                            </div>
                            <div className="carousel-item active">
                                <img src={img5} style={{ height: "500px", borderRadius: "10px" }} className="d-block w-100"
                                    alt="carousel Images" />
                            </div>
                        </div>
                        ...
                        <div className="d-flex row justify-content-evenly ">
                            <div className=" mt-4 col-lg-5 col-sm-12 col-md-12 ps-5">
                                <div className="">
                                    ...
                                    <p className="contact-link">70, 3rd Street, Crosscut road, Gandhipuram,<br />
                                ...
                                <div className="contact-details">
                                    ...
                                    <a className=" contact-link text-black" href="mailto:hello@gmail.com">deluxmedicals@gmail.com
                                    </a>
                                </div>
                                <div className="contact-details mt-4">
                                    <h4 className='text-start '><img src={"https://img.icons8.com/fluency/48/000000/phone-office.png"} /> Phone Number</h4>
                                    <a className="contact-link  text-black" href="tel:+91-1234567890">+91 6374936638
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="container d-flex flex-wrap justify-content-evenly">
                        ...
                        <div style={{ marginTop: "50px" }}>
                            <ul style={{ listStyleType: "none" }}>
                                ...
                                <li><span className="fs-5"><i className="bi bi-telephone"></i> +91 6374936638 </span></li>
                                <li><span className="fs-5"><i className="bi bi-envelope"></i> deluxmedicals@gmail.com</span></li>
                                <li><span className="fs-5"><i className="bi bi-house"></i> -Coimbatote, TamilNadu+ </span></li>
                            </ul>
                        </div>
